...
class MyBookmarksController extends BaseController
  ...
  Future<void> fetchTopics() async {
    try {
      ...
      clearError();
      final response = await apiService.getMyBookmarks();
  ...
  Future<void> loadMore() async {
    ...
    try {
      ...
      final response = await apiService.getMyBookmarks(nextPage);
